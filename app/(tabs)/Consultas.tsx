...
import { pegarConsultasPaciente } from '../../src/serviços/PacienteServico';
import { cancelarConsulta } from '../../src/serviços/ConsultaServico';
...
export default function Consultas({ navigation }: any) { // Altere para `any` temporariamente
